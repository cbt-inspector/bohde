  ...
  <div class="footeradv">
    <div class="foottable" style="margin-top:10px">
      <table style="margin-left:auto;margin-right:auto;">
        <tr>
          <th colspan="5" style="text-align:center">Contact info or smth idk</th>
        </tr>
        <tr>
...
.footeradv hr {
  border: none;
  border-top: 3px double rgba(70, 15, 29, 1);
  color: rgba(70, 15, 29, 1);
  overflow: visible;
  text-align: center;
  height: 5px;
  width: 30%;
